...
//		gridBagLayout.rowWeights = new double[]{Double.MIN_VALUE};
		...
		JLabel lblNewLabel_2 = new JLabel("Gestion de Estudiante");
		...
		btnBeforeRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Estudiante e2 = new Estudiante(Integer.parseInt(jtfId.getText()), jtfNombre.getText(), jtfApellido1.getText(), jtfApellido2.getText(),
						jtfDni.getText(), jtfDireccion.getText(), jtfEmail.getText(), jtfTelefono.getText());
				Estudiante e1 = EstudianteController.previous(e2);
				if(e1 != null) {
		...
		btnNextRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Estudiante e2 = new Estudiante(Integer.parseInt(jtfId.getText()), jtfNombre.getText(), jtfApellido1.getText(), jtfApellido2.getText(),
						jtfDni.getText(), jtfDireccion.getText(), jtfEmail.getText(), jtfTelefono.getText());
				Estudiante e1 = EstudianteController.next(e2);
				if(e1 != null) {
					jtfId.setText("" + e1.getId());
					jtfNombre.setText(e1.getNombre());
					jtfApellido1.setText(e1.getApellido1());
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(borrar == 0) {
					Estudiante e2 = new Estudiante(Integer.parseInt(jtfId.getText()), jtfNombre.getText(), jtfApellido1.getText(), jtfApellido2.getText(),
							jtfDni.getText(), jtfDireccion.getText(), jtfEmail.getText(), jtfTelefono.getText());
					EstudianteController.delete(e2);
				}
			}
		});
